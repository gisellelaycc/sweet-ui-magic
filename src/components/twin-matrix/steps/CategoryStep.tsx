...
export const CategoryStep = ({ activeModules, onUpdate, onNext }: Props) => {
  ...
  return (
    <SplitStepLayout
      title="Signal Layers"
      subtitle="Choose which aspects of yourself shape this state."
      footer={
    ...
    >
      <div className="w-full flex flex-col items-center gap-6">
        ...
        {/* Chip Row */}
        <div className="flex flex-wrap justify-center gap-2.5 max-w-[580px]">
          {chipItems.map(chip => {
            ...
            return (
              <div key={chip.id} className="relative">
                <button
                  ...
                  className="relative flex items-center justify-center gap-2 px-3.5 py-2 rounded-full text-sm transition-all duration-300"
                  style={{
                    minWidth: '110px',
                    background: isChipSelected ? 'rgba(255, 255, 255, 0.1)' : 'rgba(255, 255, 255, 0.03)',
